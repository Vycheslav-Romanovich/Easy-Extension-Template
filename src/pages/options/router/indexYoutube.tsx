...
import videoServiceSubsPanel from '../../common/video-services-content/videoServiceSubsPanel'
...
let stack: RouterStackItem[] = [{ component: videoServiceSubsPanel, props: {} }]

const forceUpdateStack: Array<() => void> = []
...
function RouterYoutube({ children }: RouterProps) {
  const update = useForceUpdate()
  ...
  const { component: Component, props } = stack[stack.length - 1] || emptyStackComponent

  return React.createElement(Component, props, children)
}

// @ts-ignore
export { goBack, getCurrent, getComponentStack, goTo, popToTop, RouterProps, NavLink, Link, RouterYoutube }
